...
const arr = [
  ...
  'Тото у меня такое ощущение что мы больше Канзасе',
  'Не судите меня за прошлое я живу там больше.',
  'Как принято считать стремящиеся вытеснить традиционное производство нанотехнологии обнародованы',
  'Не следует однако забывать том что выбранный нами инновационный',
  'Сегодняшний день она планировала завершить порцией тако',
  'У Грей намечалось свадьбы пенсии ей было далеко',
  ...
  'В отличие от мужчин женщины оставляли свою личность вместе ключами документами и неоплаченными счетами за электричество',
  'у Грей так имелось достаточно информации чтобы начать работать',
  'Люди вокруг шмыгали носами них слезились глаза Грей поежилась',
  'Вот начались вопросы ведь Грей глаза слезятся легкие чистые',
  'Так отец Грей Виктор говорит хорошеньких девушках вроде Изабель Линкольн',
  'Пройдя через двойные двери мимо людей истекавших кровью мимо астматиков гудящих аппаратов Грей наконец оказалась кабинете Иана',
  'Капля пота стекала виску смахивала',
];
...
export const Game = ({ incrementIndex, currentIndex, onFinish }) => {
